...
all_movies = movies_data[["original_title","poster_link","release_data","runtime","weighted_rating"]]
...
def recommended_movies():
    global liked_movies
    col_names = ["original_title", "poster_link", "release_date", "duration", "weighted_rating"]
